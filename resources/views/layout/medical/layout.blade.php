...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{URL::asset('medical/css/_all-skins.min.css')}}">
...
<script src="{{URL::asset('medical/js/app.min.js')}}"></script>
<!-- AdminLTE for demo purposes -->

<script src="{{URL::asset('medical/js/demo.js')}}"></script>
