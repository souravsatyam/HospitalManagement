...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{URL::asset('doctor/css/AdminLTE.min.css')}}">
  <!-- iCheck -->
  <link rel="stylesheet" href="{{URL::asset('doctor/css/_all-skins.min.css')}}">
...
<script src="{{URL::asset('doctor/js/app.min.js')}}"></script>
<!-- AdminLTE for demo purposes -->

<script src="{{URL::asset('doctor/js/demo.js')}}"></script>
